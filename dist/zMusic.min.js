    ...
    _createClass(zMusic, [{
        ...
        value: function bind() {
            ...
            this.music.addEventListener('durationchange', function (e) {
                ...
                console.log(new Date(_this2.music.duration));
                _this2.dom.time_total.innerHTML = _this2.music.duration;
            ...
            this.music.addEventListener('timeupdate', function (e) {
                ...
                if (shouldUpdate) {
                    shouldUpdate = false;
                    setTimeout(function () {
                        console.log(_this2.music.currentTime);
                        _this2.dom.time_cur.innerHTML = _this2.music.currentTime;
                        shouldUpdate = true;
                    }, 1000);
                }
        ...
        value: function getMusic(index) {
            ...
            currency.ajax({
                ...
                _this3.ct.innerHTML = template.call(_this3);
